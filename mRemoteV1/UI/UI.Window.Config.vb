...
#Region "Form Init"
            ...
            Private Sub InitializeComponent()
                ...
                Me.btnShowInheritance.Image = Global.dRemote.My.Resources.Resources.Inheritance
                ...
                Me.btnShowDefaultInheritance.Image = Global.dRemote.My.Resources.Resources.Inheritance_Default
                ...
                Me.btnShowProperties.Image = Global.dRemote.My.Resources.Resources.Properties
                ...
                Me.btnShowDefaultProperties.Image = Global.dRemote.My.Resources.Resources.Properties_Default
                ...
                Me.btnHostStatus.Image = Global.dRemote.My.Resources.Resources.HostStatus_Check
                ...
                Me.HideOnClose = True
                Me.Icon = Global.dRemote.My.Resources.Resources.Config_Icon
                Me.Name = "Config"
                Me.TabText = "Config"
                Me.Text = "Config"
...
#Region "Public Methods"
            ...
            Public Sub SetPropertyGridObject(ByVal Obj As Object)
                Try
                    ...
                    If TypeOf Obj Is dRemote.Connection.Info Then 'CONNECTION INFO
                        If TryCast(Obj, dRemote.Connection.Info).IsContainer = False Then 'NO CONTAINER
                            If Me.PropertiesVisible Then 'Properties selected
                                Me.pGrid.SelectedObject = Obj

                                Me.btnShowProperties.Enabled = True
                                If TryCast(Obj, dRemote.Connection.Info).Parent IsNot Nothing Then
                            ...
                            ElseIf Me.DefaultPropertiesVisible Then 'Defaults selected
                                ...
                                If TryCast(Obj, dRemote.Connection.Info).IsDefault Then 'Is the default connection
                                    Me.btnShowProperties.Enabled = True
                                    Me.btnShowInheritance.Enabled = False
                            ...
                            ElseIf Me.InheritanceVisible Then 'Inheritance selected
                                Me.pGrid.SelectedObject = TryCast(Obj, dRemote.Connection.Info).Inherit
                            ...
                            ElseIf Me.DefaultInheritanceVisible Then 'Default Inhertiance selected
                                ...
                                Me.PropertiesVisible = True
                            End If
                        ElseIf TryCast(Obj, dRemote.Connection.Info).IsContainer Then 'CONTAINER
                            Me.pGrid.SelectedObject = Obj

                            Me.btnShowProperties.Enabled = True
                            If TryCast(TryCast(Obj, dRemote.Connection.Info).Parent, dRemote.Container.Info).Parent IsNot Nothing Then
                                Me.btnShowInheritance.Enabled = True
                            Else
                                Me.btnShowInheritance.Enabled = False
                            End If
                        ...
                        Dim conIcon As Icon = dRemote.Connection.Icon.FromString(TryCast(Obj, dRemote.Connection.Info).Icon)
                    ...
                    ElseIf TypeOf Obj Is Root.Info Then 'ROOT
                        ...
                        End Select
                        pGrid.SelectedObject = Obj
                    ElseIf TypeOf Obj Is dRemote.Connection.Info.Inheritance Then 'INHERITANCE
                        Me.pGrid.SelectedObject = Obj
                        ...
                        If Me.InheritanceVisible Then
                            ...
                            Me.btnShowDefaultInheritance.Enabled = False
                            Me.btnIcon.Enabled = True
                            Me.btnHostStatus.Enabled = Not TryCast(TryCast(Obj, dRemote.Connection.Info.Inheritance).Parent, dRemote.Connection.Info).IsContainer

                            Me.InheritanceVisible = True

                            Dim conIcon As Icon = dRemote.Connection.Icon.FromString(TryCast(TryCast(Obj, dRemote.Connection.Info.Inheritance).Parent, dRemote.Connection.Info).Icon)
                            If conIcon IsNot Nothing Then
                                Me.btnIcon.Image = conIcon.ToBitmap
                            End If
...
#Region "Private Methods"
            ...
            Private Sub pGrid_PropertyValueChanged(ByVal s As Object, ByVal e As System.Windows.Forms.PropertyValueChangedEventArgs) Handles pGrid.PropertyValueChanged
                Try
                    If TypeOf Me.pGrid.SelectedObject Is dRemote.Connection.Info Then
                        Select Case e.ChangedItem.Label
                            Case My.Language.strPropertyNameProtocol
                                TryCast(Me.pGrid.SelectedObject, dRemote.Connection.Info).SetDefaultPort()
                            Case My.Language.strPropertyNameName
                                ...
                                If My.Settings.SetHostnameLikeDisplayName And TypeOf Me.pGrid.SelectedObject Is dRemote.Connection.Info Then
                                    Dim connectionInfo As dRemote.Connection.Info = DirectCast(Me.pGrid.SelectedObject, dRemote.Connection.Info)
                            ...
                            Case My.Language.strPropertyNameIcon
                                Dim conIcon As Icon = dRemote.Connection.Icon.FromString(TryCast(Me.pGrid.SelectedObject, dRemote.Connection.Info).Icon)
                                If conIcon IsNot Nothing Then
                                    Me.btnIcon.Image = conIcon.ToBitmap
                                End If
                        ...
                        If TryCast(Me.pGrid.SelectedObject, dRemote.Connection.Info).IsDefault Then
                    ...
                    If TypeOf Me.pGrid.SelectedObject Is dRemote.Connection.Info.Inheritance Then
                        If TryCast(Me.pGrid.SelectedObject, dRemote.Connection.Info.Inheritance).IsDefault Then
            ...
            Private Sub ShowHideGridItems()
                Try
                    ...
                    If TypeOf Me.pGrid.SelectedObject Is dRemote.Connection.Info Then
                        Dim conI As dRemote.Connection.Info = pGrid.SelectedObject
                        ...
                        Select Case conI.Protocol
                            Case dRemote.Connection.Protocol.Protocols.RDP
                                ...
                                If conI.RDGatewayUsageMethod = dRemote.Connection.Protocol.RDP.RDGatewayUsageMethod.Never Then
                            ...
                            Case dRemote.Connection.Protocol.Protocols.VNC
                                ...
                                If conI.VNCAuthMode = dRemote.Connection.Protocol.VNC.AuthMode.AuthVNC Then
                                    strHide.Add("Username")
                                    strHide.Add("Domain")
                                End If
                                If conI.VNCProxyType = dRemote.Connection.Protocol.VNC.ProxyType.ProxyNone Then
                                    strHide.Add("VNCProxyIP")
                                    strHide.Add("VNCProxyPassword")
                                    strHide.Add("VNCProxyPort")
                                    strHide.Add("VNCProxyUsername")
                                End If
                            Case dRemote.Connection.Protocol.Protocols.SSH1
                                strHide.Add("CacheBitmaps")
                                strHide.Add("Colors")
                                strHide.Add("DisplayThemes")
                                strHide.Add("DisplayWallpaper")
                                ...
                                strHide.Add("VNCSmartSizeMode")
                                strHide.Add("VNCViewOnly")
                            Case dRemote.Connection.Protocol.Protocols.SSH2
                                strHide.Add("CacheBitmaps")
                                strHide.Add("Colors")
                                strHide.Add("DisplayThemes")
                                strHide.Add("DisplayWallpaper")
                                ...
                                strHide.Add("VNCSmartSizeMode")
                                strHide.Add("VNCViewOnly")
                            Case dRemote.Connection.Protocol.Protocols.Telnet
                                strHide.Add("CacheBitmaps")
                                strHide.Add("Colors")
                                strHide.Add("DisplayThemes")
                                strHide.Add("DisplayWallpaper")
                                ...
                                strHide.Add("VNCSmartSizeMode")
                                strHide.Add("VNCViewOnly")
                            Case dRemote.Connection.Protocol.Protocols.Rlogin
                                strHide.Add("CacheBitmaps")
                                strHide.Add("Colors")
                                strHide.Add("DisplayThemes")
                                strHide.Add("DisplayWallpaper")
                                ...
                                strHide.Add("VNCSmartSizeMode")
                                strHide.Add("VNCViewOnly")
                            Case dRemote.Connection.Protocol.Protocols.RAW
                                strHide.Add("CacheBitmaps")
                                strHide.Add("Colors")
                                strHide.Add("DisplayThemes")
                                strHide.Add("DisplayWallpaper")
                                ...
                                strHide.Add("VNCSmartSizeMode")
                                strHide.Add("VNCViewOnly")
                            Case dRemote.Connection.Protocol.Protocols.HTTP
                                strHide.Add("CacheBitmaps")
                                strHide.Add("Colors")
                                strHide.Add("DisplayThemes")
                                strHide.Add("DisplayWallpaper")
                                ...
                                strHide.Add("VNCSmartSizeMode")
                                strHide.Add("VNCViewOnly")
                            Case dRemote.Connection.Protocol.Protocols.HTTPS
                                strHide.Add("CacheBitmaps")
                                strHide.Add("Colors")
                                strHide.Add("DisplayThemes")
                                strHide.Add("DisplayWallpaper")
                                ...
                                strHide.Add("VNCSmartSizeMode")
                                strHide.Add("VNCViewOnly")
                            Case dRemote.Connection.Protocol.Protocols.ICA
                                strHide.Add("DisplayThemes")
                                strHide.Add("DisplayWallpaper")
                                strHide.Add("EnableFontSmoothing")
                                strHide.Add("EnableDesktopComposition")
                                ...
                                strHide.Add("VNCSmartSizeMode")
                                strHide.Add("VNCViewOnly")
                            Case dRemote.Connection.Protocol.Protocols.IntApp
                                strHide.Add("CacheBitmaps")
                                strHide.Add("Colors")
                                strHide.Add("DisplayThemes")
                                strHide.Add("DisplayWallpaper")
            ...
            Private Sub btnShowProperties_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnShowProperties.Click
                If TypeOf Me.pGrid.SelectedObject Is dRemote.Connection.Info.Inheritance Then
                    If TryCast(Me.pGrid.SelectedObject, dRemote.Connection.Info.Inheritance).IsDefault Then
                        ...
                        Me.SetPropertyGridObject(TryCast(App.Runtime.Windows.treeForm.tvConnections.SelectedNode.Tag, dRemote.Root.Info))
                    Else
                        Me.PropertiesVisible = True
                        Me.InheritanceVisible = False
                        Me.DefaultPropertiesVisible = False
                        Me.DefaultInheritanceVisible = False
                        Me.SetPropertyGridObject(TryCast(Me.pGrid.SelectedObject, dRemote.Connection.Info.Inheritance).Parent)
                    End If
                ElseIf TypeOf Me.pGrid.SelectedObject Is dRemote.Connection.Info Then
                    If TryCast(Me.pGrid.SelectedObject, dRemote.Connection.Info).IsDefault Then
                        Me.PropertiesVisible = True
                        Me.InheritanceVisible = False
                        Me.DefaultPropertiesVisible = False
            ...
            Private Sub btnShowDefaultProperties_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnShowDefaultProperties.Click
                If TypeOf Me.pGrid.SelectedObject Is dRemote.Root.Info Or TypeOf Me.pGrid.SelectedObject Is dRemote.Connection.Info.Inheritance Then
            ...
            Private Sub btnShowInheritance_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnShowInheritance.Click
                If TypeOf Me.pGrid.SelectedObject Is dRemote.Connection.Info Then
                    ...
                    Me.DefaultPropertiesVisible = False
                    Me.DefaultInheritanceVisible = False
                    Me.SetPropertyGridObject(TryCast(Me.pGrid.SelectedObject, dRemote.Connection.Info).Inherit)
                End If
            End Sub
            ...
            Private Sub btnShowDefaultInheritance_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnShowDefaultInheritance.Click
                If TypeOf Me.pGrid.SelectedObject Is dRemote.Root.Info Or TypeOf Me.pGrid.SelectedObject Is dRemote.Connection.Info Then
                    Me.PropertiesVisible = False
                    Me.InheritanceVisible = False
                    Me.DefaultPropertiesVisible = False
                    Me.DefaultInheritanceVisible = True
                    ...
                    If TypeOf pGrid.SelectedObject Is dRemote.Connection.Info And _
                       Not TypeOf pGrid.SelectedObject Is dRemote.Connection.PuttySession.Info Then
                        ...
                        For Each iStr As String In dRemote.Connection.Icon.Icons
                            ...
                            tI.Text = iStr
                            tI.Image = dRemote.Connection.Icon.FromString(iStr).ToBitmap
            ...
            Private Sub IconMenu_Click(ByVal sender As Object, ByVal e As EventArgs)
                Try
                    Dim connectionInfo As dRemote.Connection.Info = TryCast(pGrid.SelectedObject, dRemote.Connection.Info)
                    ...
                    Dim connectionIcon As Icon = dRemote.Connection.Icon.FromString(iconName)
...
#Region "Host Status (Ping)"
            ...
            Public Sub SetHostStatus(ByVal ConnectionInfo As Object)
                Try
                    ...
                    ' To check status, ConnectionInfo must be an dRemote.Connection.Info that is not a container
                    If TypeOf ConnectionInfo Is dRemote.Connection.Info Then
                        If TryCast(ConnectionInfo, dRemote.Connection.Info).IsContainer Then Return
                    Else
                        Return
                    End If
